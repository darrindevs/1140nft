...
const NavDark = (
    <Navbar bg="" expand="lg" className="navbar-dark navbar sticky-top">
      <Navbar.Brand href="/" className="brando mark-1 ms-3">1140nft</Navbar.Brand>
      ...
      <Navbar.Collapse className="justify-content-end me-3">
        ...
        <span></span>
         ...
         <span className="nav-item me-3" id="opensea"><a href=""><img className="nav-icon mb-1" src="https://storage.googleapis.com/opensea-static/Logomark/Logomark-Blue.svg"/></a></span>
         <span className="nav-item me-4" id="twitter"><a href=""><FontAwesomeIcon icon={faTwitter} className="fa-icon fa-xl"/></a></span>
         <span className="nav-item me-3" id="discord"><a href=""><FontAwesomeIcon icon={faDiscord} className="fa-icon fa-xl"/></a></span>
        </Navbar.Text>
      </Navbar.Collapse>
  </Navbar>
)
